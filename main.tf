...
module "maintenance_configurations" {
  source                     = "git::https://github.com/AeternaModules/azurerm_maintenance_configuration.git?ref=v5.0.0"
  maintenance_configurations = local.maintenance_configurations
}

module "maintenance_assignment_dedicated_hosts" {
  source                                 = "git::https://github.com/AeternaModules/azurerm_maintenance_assignment_dedicated_host.git?ref=v5.0.0"
...
module "maintenance_assignment_dynamic_scopes" {
  source                                = "git::https://github.com/AeternaModules/azurerm_maintenance_assignment_dynamic_scope.git?ref=v5.0.0"
...
module "maintenance_assignment_virtual_machines" {
  source                                  = "git::https://github.com/AeternaModules/azurerm_maintenance_assignment_virtual_machine.git?ref=v5.0.0"
...
module "maintenance_assignment_virtual_machine_scale_sets" {
  source                                            = "git::https://github.com/AeternaModules/azurerm_maintenance_assignment_virtual_machine_scale_set.git?ref=v5.0.0"
